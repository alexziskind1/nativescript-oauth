...
export function initOffice365(
  options: TnsOAuth.ITnsOAuthOptionsOffice365
): Promise<any> {
  console.error(
    "This plugin is deprecated, Please use the new nativescript-oauth2 plugin"
  );
...
export function initFacebook(
  options: TnsOAuth.ITnsOAuthOptionsFacebook
): Promise<any> {
  console.error(
    "This plugin is deprecated, Please use the new nativescript-oauth2 plugin"
  );
  return new Promise(function(resolve, reject) {
    try {
      ...
      instance = new AuthHelperFacebook(
        options.clientId,
...
export function initGoogle(
  options: TnsOAuth.ITnsOAuthOptionsGoogle
): Promise<any> {
  console.error(
    "This plugin is deprecated, Please use the new nativescript-oauth2 plugin"
  );
...
export function initLinkedIn(
  options: TnsOAuth.ITnsOAuthOptionsLinkedIn
): Promise<any> {
  console.error(
    "This plugin is deprecated, Please use the new nativescript-oauth2 plugin"
  );
  return new Promise(function(resolve, reject) {
    try {
      ...
      instance = new AuthHelperLinkedIn(
        options.clientId,
        options.clientSecret,
        options.redirectUri,
        options.scope
...
export function initSalesforce(
  options: TnsOAuth.ITnsOAuthOptionsSalesforce
): Promise<any> {
  console.error(
    "This plugin is deprecated, Please use the new nativescript-oauth2 plugin"
  );
...
export function initCustom(
  options: TnsOAuth.ITnsOAuthOptionsCustom
): Promise<any> {
  console.error(
    "This plugin is deprecated, Please use the new nativescript-oauth2 plugin"
  );
